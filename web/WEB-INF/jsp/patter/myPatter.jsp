...
<body>
	...
	<div class="wordsNav">
		<ul class="subNav">
            <li data-id="1">java</li>
            <li data-id="2">python</li>
			<li data-id="3">html5</li>
        </ul>
        <div class="navMenu">
        	<ul>
        	<%--	<li><a href="javascript:;">课程大纲</a></li>
        		<li><a href="javascript:;">课程时间</a></li>
        		<li><a href="javascript:;">学习费用</a></li>--%>
        	<%--	<li><a href="javascript:;">课程4开场白</a></li>
        		<li><a href="javascript:;">课程5开场白</a></li>
        		<li><a href="javascript:;">课程6开场白</a></li>
        		<li><a href="javascript:;">课程7开场白</a></li>--%>
        	</ul>
        </div>        	
	</div>	
	<div class="meun-btn">
