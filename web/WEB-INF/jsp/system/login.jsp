...
<div class="content">
	<div class="header">
	  <h1 class="ui_tit" align="center">欢迎登录和佳信息管理系统</h1>
	</div>	
    <form action="${PATH }/toLogin.do" method="post" onsubmit="return loginValidate();" id="loginform">
		  	...
		  	<ul>
				<li>
					<div class="form-group">
					    <div class="input-group">
					      ...
					      <input type="text" class="text" id="email" placeholder="请输入用户名" name="email" ><b id="eamilspan" style="color: red"></b>
					    </div>
					  </div>					
				...
				<li>
					<div class="input-group">
				      ...
				      <input type="password" class="text" id="password" name="password"  placeholder="请输入密码"><b id="passspan" style="color: red"></b>
				    </div>
				</li>      				
		  	</ul>
	    </div>          
...
<script type="text/javascript">
	/*$(function () {
        $("#email").bind("blur",function () {
            ...
            if(usernameObj==null||usernameObj==""){
                alert("sda")
                $("#eamilspan").html("*")
            }
        })
        $("#password").bind("blur",function () {
            ...
            if(passwordObj==null||passwordObj==""){
                alert("sdasss")
                $("#passspan").html("*")
            }
        })
